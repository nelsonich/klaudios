...
@section('content')
    ...
    <div class="container">
            ...
            <table class="table table-striped table-dark mb-5">
                ...
                <tbody>
                    @foreach ($news as $item)
                        <tr>
                            ...
                            <th scope="row">
                                <a type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                    data-target="#editNewsModal{{ $item->id }}">
                                    <i class="fas fa-edit"></i>
                                </a>
                            </th>
                            <th scope="row">
                                <a type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                    data-target="#deleteNewsModal{{ $item->id }}">
                        ...
                        <!-- Delete News Modal -->
                        <div class="modal fade" id="deleteNewsModal{{ $item->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="deleteNewsModalTitle{{ $item->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content p-1">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="deleteNewsModalTitle{{ $item->id }}">Delete News
                                            ({{ $item->title }})</h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('delete-news', ['id' => $item->id]) }}" method="post"
                        ...
                        <div class="modal fade" id="editNewsModal{{ $item->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="editNewsModalTitle{{ $item->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content p-1">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editNewsModalTitle{{ $item->id }}">Edit News
                                            ({{ $item->title }})</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('edit-news', ['id' => $item->id]) }}" method="post"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                name="image" id="image">
                                                            <input type="hidden" name="newsoldimage"
                                                                value="{{ $item->image }}">
        ...
        <!-- Add News Modal -->
        <div class="modal fade" id="addNewsModal" tabindex="-1" role="dialog" aria-labelledby="addNewsModalTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content p-1">
                    <div class="modal-header">
